 ...
 */
  ...
  */
   ...
   * @param userData 
   */
  progress_handler(db: number, nProgressOps: number, handler: (userData: any) => number, userData: any): void;
   ...
   * @param sql 
   */
  statements(db: number, sql: string | TemplateStringsArray): AsyncIterable<number>;
